...
namespace TodoApi.Attributes
{
    ...
    sealed public class RolesAttribute : ValidationAttribute
    {
        ...
        protected override ValidationResult IsValid(object? value, ValidationContext validationContext)
        {
            if (value != null)
            {
                Regex rgx = new Regex("^(EMPLOYEE|ADMIN|EMPLOYEEADMIN|ADMINEMPLOYEE)$");
